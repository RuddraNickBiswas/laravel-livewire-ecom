...
{{--{{ asset('fn/') }}--}}
    ...
    <!-- Document Title
    ============================================= -->
    <title>Header - Responsive Sticky | Canvas</title>
        ...
        <div id="header-wrap">
            <div class="container">
                <div class="header-row">
                    ...
                    <div id="logo">
                        <a href="index.html">
                            <img class="logo-default" srcset="{{ asset('fn/images/logo.png, images/logo@2x.png 2x') }}" src="{{ asset('fn/images/logo@2x.png') }}" alt="Canvas Logo">
                            <img class="logo-dark" srcset="{{ asset('fn/images/logo-dark.png, images/logo-dark@2x.png 2x') }}" src="{{ asset('fn/images/logo-dark@2x.png') }}" alt="Canvas Logo">
                        </a>
                    </div><!-- #logo end -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-lg-auto mt-4 mt-lg-0">
                            <a href="#" class="button button-reveal button-large button-circle text-end m-0"><i class="uil uil-angle-right-b"></i><span>Browse Now</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row col-mb-50">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="feature-box fbox-effect">
                            <div class="fbox-icon">
                                <a href="#"><i class="bi-eye i-alt"></i></a>
                            </div>
                            <div class="fbox-content">
                ...
                <div id="oc-clients-full" class="owl-carousel image-carousel carousel-widget" data-margin="60" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
...
<!-- JavaScripts
============================================= -->
<script src="{{ asset('fn/js/plugins.min.js') }}"></script>
<script src="{{ asset('fn/js/functions.bundle.js') }}"></script>
