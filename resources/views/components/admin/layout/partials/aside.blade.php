...
<div
	...
	data-kt-scroll-offset="5px">
			<a href="?page=apps/calendar" class="btn btn-icon btn-color-primary bg-hover-body h-45px w-45px flex-shrink-0"
			data-bs-toggle="tooltip" title="Calendar" data-bs-custom-class="tooltip-inverse"
		>
			<i class="ki-outline ki-calendar fs-2x"></i>		</a>
			<a href="?page=account/overview" class="btn btn-icon btn-color-warning bg-hover-body h-45px w-45px flex-shrink-0"
			data-bs-toggle="tooltip" title="Profile" data-bs-custom-class="tooltip-inverse"
		>
			<i class="ki-outline ki-address-book fs-2x"></i>		</a>
			<a href="?page=apps/ecommerce/catalog/products" class="btn btn-icon btn-color-success bg-hover-body h-45px w-45px flex-shrink-0"
			data-bs-toggle="tooltip" title="Messages" data-bs-custom-class="tooltip-inverse"
		>
			<i class="ki-outline ki-tablet-ok fs-2x"></i>		</a>
			<a href="?page=apps/inbox/listing" class="btn btn-icon btn-color-dark bg-hover-body h-45px w-45px flex-shrink-0"
			data-bs-toggle="tooltip" title="Products" data-bs-custom-class="tooltip-inverse"
		>
			<i class="ki-outline ki-calendar-add fs-2x"></i>		</a>
	</div>
<!--end::Wrapper--></div>
<!--end::aside-->
