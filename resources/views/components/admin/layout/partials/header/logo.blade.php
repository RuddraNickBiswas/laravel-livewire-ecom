<div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
    ...
    <a href="?page=index" class="app-sidebar-logo">
        <img alt="Logo" src="{{ asset('admin/assets/media/logos/demo39.svg') }}" class="h-25px theme-light-show"/>
        <img alt="Logo" src="{{ asset('admin/assets/media/logos/demo39-dark.svg') }}" class="h-25px theme-dark-show"/>
    </a>
    <!--end::Logo-->
</div>
