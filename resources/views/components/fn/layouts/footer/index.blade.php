                    ...
                    <div class="row col-mb-50">
                        <div class="col-md-4">
                            ...
                            <div class="widget">
                                ...
                                <img src="{{ asset('fn/images/footer-widget-logo.png') }}" alt="Image" class="footer-logo">

                                <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>

                                <div style="background: url( {{ asset('fn/images/world-map.png') }}) no-repeat center center; background-size: 100%;">
                                    <address>
