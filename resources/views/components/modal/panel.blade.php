<template x-teleport="body">
    ...
    >
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mx-auto d-flex justify-content-center align-items-end align-items-sm-center min-vh-100 p-0 p-sm-4">
                <div
                    x-dialog:panel
                    x-transition.in
                    class="position-relative max-w-xl  bg-white rounded rounded-bottom-sm-xl shadow-lg overflow-hidden"

                >
                    <!-- Mobile: Top "grab" handle... -->
                    <div
                        class="d-sm-none position-absolute top-n10 start-0 end-0 z-2"
                        style="height: 5rem"
