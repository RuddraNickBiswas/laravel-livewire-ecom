    ...
    public function getTabs(): array
    {
        return [
            ...
            OrderStatus::New->getLabel() => Tab::make()
                ...
                ->badge(Order::where('status', OrderStatus::New->value)->count()),
